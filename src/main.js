    ...
    messages: [
      {
        ...
        content: [
          {
            type: "text",
            text: `Analyze the artwork and/or photograph and provide a query to search a vector database for similar artworks. You do not have to identify people, only form the query. Be as specific as you can in your analysis but produce an efficient query.
