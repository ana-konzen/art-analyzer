    ...
    messages: [
      {
        ...
        content: [
          {
            type: "text",
            text: `Analyze the artwork and provide a query to search a vector database for similar artworks. Be as specific as you can in your analysis but produce an efficient query.
